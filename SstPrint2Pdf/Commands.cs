...
namespace SstPrint2Pdf
{
    ...
    public class Commands
    {
       ...
       //[CommandMethod("CreateFramesLayouts")]
       //public void CreateFramesLayouts()
       //{
       //    try
       //    {
       ...
       //        string prjnumber = _drawing.Ed.GetStringValue("Укажите номер проекта: ");
       ...
       //                }
       //            }
       //            int firstn = _drawing.Ed.GetNaturalValue("Введите номер первого листа:", 1, false);
